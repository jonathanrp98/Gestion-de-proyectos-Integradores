...
if (!$is_ajax) {
    ...
    $this->set_js_lib($this->default_theme_path.'/materializecss/js/form/add.js');
...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="<?php echo $this->theme_config['crud_container_class'] ?> gc-container">
	 ...
	 <ul class="collapsible" data-collapsible="accordion">
	    <li>
	      <div class="collapsible-header <?php echo $this->theme_config['grocery_crud_dialog_color'] ?> <?php echo $this->theme_config['grocery_crud_dialog_text_color'] ?>-text lighten-2 active"><i class="material-icons">edit</i><?php echo $this->l('form_add'); ?> <?php echo $subject?></div>
...
?>
<script type="text/javascript" src="<?php echo base_url($this->default_theme_path.'/materializecss/js/form/add.js');?>"></script>
