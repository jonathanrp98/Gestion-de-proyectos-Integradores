...
<div class="container">
		<div class="informacion">
            ...
            ?>
                ...
                <input type="text" name="asesoria" value="<?= $consecAsesoria ?>" hidden>
					<table class="table table-hover" border="1px">
						...
						<tr>
							<td>FECHA: <input type="date" name="fecha" id="fecha" class="form-control" value="<?= $inf->fecha ?>" required></td>
							<td>HORA INICIO: <input type="text" id="hora" name="hora" class="form-control" placeholder="hh:mm" value="<?= $inf->horaInicio ?>" required>
							</td>
							<td>HORA FINALIZACIÓN: <input type="text" id="horaF" name="horaF" class="form-control"
									placeholder="hh:mm" value="<?= $inf->horaFin ?>" required></td>
						</tr>
					</table>
					<table class="table table-hover" border="1px">
						<tr class="table-secondary">
						...
						<tr>
							<td><textarea id="objetivos" name="objetivos" rows="4" cols="50" class="form-control" required><?= $inf->objetivoAsesoria ?></textarea>
							</td>
						</tr>
					</table>
					<table class="table table-hover" border="1px">
						...
						<tr>
							<td><textarea id="recomendaciones" name="recomendaciones" rows="4" cols="50" class="form-control"
									required><?= $inf->recomendaciones ?></textarea></td>
						</tr>
					</table>
					<table class="table table-hover" border="1px">
						<tr class="table-secondary">
						...
						<tr>
							<td><textarea id="actividades" name="actividades" rows="4" cols="50" class="form-control"
									required><?= $inf->actividadesPendietes ?></textarea></td>
						</tr>
					</table>
					<table class="table table-hover" border="1px">
						<tr class="table-secondary">
						...
						<tr>
							<td><input type="date" name="proxReunion" id="fecha" class="form-control" value="<?= $inf->fecha_proxima_reunion ?>"></td>
						</tr>
					</table>
					<table class="table table-hover" border="1px">
						<tr class="table-secondary">
            ...
            { 
              if($inf->usuario_id_asesor == $row->id_usuario){
