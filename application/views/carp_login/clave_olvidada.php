				...
				<div id="cardLogin">
					<div class="card" class="login"><br>
						...
						<img src="<?php echo base_url(); ?>src/icons/login.svg" class="card-img-top" width="120"
							height="100" alt="...">
						<div class="card-body">
							<h2 class="card-title" >Olvidé mi contraseña</h2>
							<form class="px-4 py-3" method="post"
								action="<?php echo base_url(); ?>index.php/login/recuperar_clave">
								<select name="rol" id="" class="btn btn-primary" onchange="carg(this);" required>
								...
								<div class="form-group">
									<input type="email" class="form-control" id="email"
										name="email" placeholder="Correo eléctronico" required>
								</div>
