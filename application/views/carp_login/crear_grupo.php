...
<body>
    ...
    <div class="container" style="text-align:center">
        <div class="row">
            ...
            <div class="col-8">
                <div id="cardLogin">
                    <div class="card" class="login"><br>
                        <h2 style="color:#0000ff";><i class="fas fa-users"></i> Crear un grupo</h2>
                        <hr>
                        <?= $mensaje; ?>
                        <form action="<?php echo base_url(); ?>index.php/inicio/creargrupo" method="post">
                        <div class="form-row">
                            <div class="col-2">
                            ...
                            <div class="col-8">
                                <div class="col-md-12 mb-3">
                                    <input type="text" class="form-control" name="identificacion"
                                        placeholder="N° de identificación del estudiante" required>
                                </div>
            ...
            { 
              echo '<option value="'.$row->cod_programa.'">'.$row->nombre.'</option>';
            }
            ?>
								</select>
                                </div>
            ...
            ?>
                                ...
                                <button class="btn btn-primary" type="submit">Crear <i class="fas fa-plus-circle"></i></button>
                                <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/login">Cancelar <i
