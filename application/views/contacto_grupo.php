...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					...
					<a class="nav-item nav-link nav-hover  active" href="<?php echo base_url();?>index.php/grupo/contacto">Contacto<span
        ...
        <div class="informacion"><br>
           <header><img src="<?php echo base_url();?>src/contacto.jpg" class="img-fluid" alt="Responsive image"></header><br>
            <div class="container"><br>
                ...
                <div class="gestion">
                    <?= $mensaje; ?>
                    <form action="<?php echo base_url();?>index.php/grupo/enviar_mensaje" method="post">
                        ...
                        <br><input type="hidden" placeholder="" name="otroAsunto" id="otroAsunto" disabled><br>
                        <textarea name="mensaje" rows="5" id="mensaje" class="form-control" aria-label="With textarea" placeholder="Mensaje... Por favor seleccione un asunto" required disabled></textarea><br>
